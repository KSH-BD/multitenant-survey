...
urlpatterns = [
    ...
    path('tenant/<int:id>/users/<int:userid>/delete/', delete_user, name='delete_user'),
    ...
    path('tenant/<int:id>/employeelist/<int:empid>/delete', delete_employee, name='delete_employee'),
